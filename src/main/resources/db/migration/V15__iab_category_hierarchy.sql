...
INSERT INTO category_i18n (category_id, lang, label, description)
VALUES
    ('10000000-0000-0000-0000-000000000001', 'ko', '영화',         '영화 콘텐츠'),
    ('10000000-0000-0000-0000-000000000002', 'ko', 'TV 프로그램',  'TV 시리즈 및 방송'),
    ('10000000-0000-0000-0000-000000000003', 'ko', '엔터테인먼트', '종합 엔터테인먼트'),
    ('10000000-0000-0000-0000-000000000004', 'ko', '뉴스/정치',    '뉴스 및 정치 콘텐츠'),
    ('10000000-0000-0000-0000-000000000005', 'ko', '스포츠',       '스포츠 콘텐츠'),
    ('10000000-0000-0000-0000-000000000006', 'ko', '교육',         '교육 프로그램'),
    ('10000000-0000-0000-0000-000000000007', 'ko', '과학',         '과학과 자연'),
    ('10000000-0000-0000-0000-000000000008', 'ko', '기술',         '기술 및 컴퓨팅'),
    ('10000000-0000-0000-0000-000000000009', 'ko', '음식',         '요리 및 음식 콘텐츠'),
    ('10000000-0000-0000-0000-000000000010', 'ko', '여행',         '여행 프로그램'),
    ('10000000-0000-0000-0000-000000000011', 'ko', '건강/피트니스','건강과 웰빙'),
    ('10000000-0000-0000-0000-000000000012', 'ko', '음악',         '음악 콘텐츠'),
    ('10000000-0000-0000-0000-000000000013', 'ko', '다큐멘터리',   '다큐멘터리 영화 및 시리즈'),
    ('10000000-0000-0000-0000-000000000014', 'ko', '키즈/가족',    '가족 친화 콘텐츠'),
    ('10000000-0000-0000-0000-000000000015', 'ko', '애니메이션',   '애니메이션 콘텐츠')
ON CONFLICT (category_id, lang) DO NOTHING;
